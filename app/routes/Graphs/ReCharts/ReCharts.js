...
export const ReCharts = () => (
	<Container>
		...
		<p>
			...
			charts in React applications without any pain. Main principles of Recharts are:
		</p>
		<ul className="mb-5">
			<li>
		...
		<Row>
			<Col lg={12}>
				<HeaderDemo
					no={1}
					title="Bar Charts"
					subTitle={<React.Fragment>Quickly build your charts with decoupled, reusable React components.</React.Fragment>}
				/>
			</Col>
		</Row>
		{/* END Header 1 */}
